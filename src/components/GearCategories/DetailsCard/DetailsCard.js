...
const DetailsCard = (props) => {
  ...
  return (
    <div>
      return (
      <div className=" sm:my-0  md:ml-4 md:mr-4 lg:m-14  lg:w-11/12 group -mt-10 rounded-xl bg-white relative transition-all duration-300 md:ring-4 md:ring-blue-500 justify-center items-center flex flex-col">
